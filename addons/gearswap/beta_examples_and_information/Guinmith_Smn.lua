...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {
        main={ name="Grioavolr", augments={'Blood Pact Dmg.+9','Pet: STR+11','Pet: Mag. Acc.+10','Pet: "Mag.Atk.Bns."+19',}},
        sub="Elan Strap +1",
        ...
        feet={ name="Merlinic Crackows", augments={'Accuracy+18','"Drain" and "Aspir" potency +9','CHR+7','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
    ...
    sets.precast.FC = {
        ...
        sub="Elan Strap +1",
        ammo="Sancus Sachet +1",
        head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+15','Magic burst dmg.+11%','Mag. Acc.+8',}},
        body={ name="Merlinic Jubbah", augments={'Accuracy+11','"Fast Cast"+3','INT+10','Mag. Acc.+5',}},
        hands={ name="Glyphic Bracers", augments={'Inc. Sp. "Blood Pact" magic burst dmg.',}},
        legs={ name="Lengo Pants", augments={'INT+7','Mag. Acc.+8','"Mag.Atk.Bns."+7',}},
        feet={ name="Merlinic Crackows", augments={'Accuracy+18','"Drain" and "Aspir" potency +9','CHR+7','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
        neck="Baetyl Pendant",
    ...
    sets.precast.FC['Healing Magic'] = set_combine(sets.precast.FC, {sub="Sors Shield", right_ear="Mendicant's Earring"})
    ...
    sets.midcast.FastRecast = {
        ...
        head="Beckoner's Horn +1",
        body="Shomonjijoe +1",
        hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+20 Pet: Rng. Acc.+20','Blood Pact Dmg.+10','Pet: STR+9',}},
        legs="Assid. Pants +1",
        feet={ name="Merlinic Crackows", augments={'Accuracy+18','"Drain" and "Aspir" potency +9','CHR+7','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
        neck="Caller's Pendant",
        waist="Witful Belt",
    ...
    sets.midcast.Stoneskin = set_combine(sets.midcast['Healing Magic'], {feet="Inspirited Boots"})

    sets.midcast.Refresh = set_combine(sets.midcast['Healing Magic'], {feet="Inspirited Boots"})
    ...
    sets.midcast.Pet.MagicalBloodPactRage = {
        ...
        body="Convoker's Doublet +3",
        hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Blood Pact Dmg.+10','Pet: DEX+7','Pet: "Mag.Atk.Bns."+8',}},
