...
function init_gear_sets()
    ...
    sets.midcast.ElementalEnfeeble = set_combine(sets.midcast['Enfeebling Magic'], {
		...
		head="Befouled Crown",neck="Erra Pendant",ear1="Digni. Earring",ear2="Regal Earring",
        body="Vanya Robe",hands="Regal Cuffs",ring1="Kishar Ring",ring2="Stikini Ring",
		--waist="Acuity Belt +1", feet="Sorceror's Sabots +2"
        back=gear.nuke_jse_back, waist="Luminary Sash", legs="Psycloth Lappas",feet="Uk'uxkaj Boots"})
    ...
    sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",
		...
		body="Vrikodara Jupon",hands=gear.merlinic_refresh_hands,ring1="Dark Ring",ring2="Defending Ring",
		back=gear.FC_jse_back,waist="Refoccilation Stone",legs="Assid. Pants +1",feet=gear.merlinic_refresh_feet}
    ...
    sets.idle.PDT = {main="Terra's Staff",sub="Oneiros Grip",ammo="Staunch Tathlum",
        ...
        body="Vrikodara Jupon",hands=gear.merlinic_refresh_hands,ring1="Dark Ring",ring2="Defending Ring",
        back=gear.FC_jse_back,waist="Flax Sash",legs="Assid. Pants +1",feet="Mallquis Clogs +2"}
    ...
    sets.defense.MDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
        ...
        back=gear.FC_jse_back,waist="Flax Sash",legs="Hagondes Pants +1",feet="Mallquis Clogs +2"}
    ...
    sets.defense.MEVA = {main="Terra's Staff",sub="Enki Strap",ammo="Staunch Tathlum",
        ...
        back=gear.FC_jse_back,waist="Luminary Sash",legs="Hagondes Pants +1",feet=gear.merlinic_nuke_feet}
