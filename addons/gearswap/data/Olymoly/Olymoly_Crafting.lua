function get_sets()
	...
	sets.fishing = {
		range='Lu Sh. F. Rod +1', head="Tlahtlamah Glasses", neck="Fisher's Torque", 		
	...
	sets.crafting.hq = {ring1="Orvail Ring", ring2="Craftmaster's Ring"}
	...
	sets.crafting.wood = {sub="Joiner's Aspis", neck="Carver's Torque", body="Carpenter's Smock", hands="Carpenter's Gloves",}
	sets.crafting.wood.nq = {ring1="Carpenter's Ring"}
	
	sets.synergy = {body="Woodworking Smock", }
