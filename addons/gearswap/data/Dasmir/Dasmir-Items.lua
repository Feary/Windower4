...
gear.chironic_macc_legs = {name="Chironic Hose", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','"Drain" and "Aspir" potency +9','INT+8','Mag. Acc.+15','"Mag.Atk.Bns."+3',}}
...
gear.merlinic_nuke_feet = {name="Merlinic Crackows", augments={'STR+12','MND+1','"Refresh"+2','Accuracy+15 Attack+15','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
