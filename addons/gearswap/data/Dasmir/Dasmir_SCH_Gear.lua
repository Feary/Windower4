...
function init_gear_sets()
	...
	sets.midcast.Cursna = {main="Oranyan", sub="Clemency Grip", ammo="Hasty Pinion +1",
		...
		back=gear.FC_jse_back, waist="Witful Belt"}
		
	sets.midcast.StatusRemoval = set_combine(sets.midcast.FastRecast, {main="Oranyan",})--sub="Clemency Grip"

	-- 500 Skill
	sets.midcast['Enhancing Magic'] = {main=gear.gada_enhancing_club,sub="Ammurapi Shield", ammo="Savant's Treatise",
		-- neck="Incanter's Torque", ear2="Augment. Earring",
		head=gear_telchine_head_Duration, ear1="Andoaa Earring",
		body=gear_telchine_body_Duration,hands=gear_telchine_hands_Duration,ring1="Stikini Ring",ring2="Stikini Ring",
		-- Fi Follet Cape +1 waist="Olympus Sash",
		back="Fi Follet Cape",legs=gear_telchine_legs_Duration,feet=gear_telchine_feet_Duration}
