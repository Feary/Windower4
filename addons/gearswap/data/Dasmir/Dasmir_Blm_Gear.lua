...
function init_gear_sets()
	...
	sets.midcast['Enhancing Magic'] = {main="Tamaxchi",sub="Ammurapi Shield",ammo="Hasty Pinion +1",
    ...
    sets.midcast.Stun = {main="Kaja Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
    ...
    sets.midcast['Elemental Magic'] = {main="Kaja Rod",sub="Ammurapi Shield",ammo="Ghastly Tathlum",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Kaja Rod",sub="Ammurapi Shield",ammo="Ghastly Tathlum",
        head="Mallquis Chapeau +2",neck="Saevus Pendant +1",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Mallquis Saio +2",hands="Mallquis Cuffs +2",ring1="Jhakri Ring",ring2="Shiva Ring",
        back=gear.Nuke_jse_back,waist=gear.ElementalObi,legs="Mallquis Trews +2",feet="Mallquis Clogs +2"}
		
    sets.midcast['Elemental Magic'].Fodder = {main="Kaja Rod",sub="Ammurapi Shield",ammo="Ghastly Tathlum",
        head="Mallquis Chapeau +2",neck="Saevus Pendant +1",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Mallquis Saio +2",hands="Mallquis Cuffs +2",ring1="Jhakri Ring",ring2="Shiva Ring",
        back=gear.Nuke_jse_back,waist=gear.ElementalObi,legs="Mallquis Trews +2",feet="Mallquis Clogs +2"}

	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {
		main="Kaja Rod",sub="Ammurapi Shield",ammo="Ghastly Tathlum",
        head="Mallquis Chapeau +2",neck="Saevus Pendant +1",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Mallquis Saio +2",hands="Mallquis Cuffs +2",ring1="Jhakri Ring",ring2="Shiva Ring",
        back=gear.Nuke_jse_back,waist=gear.ElementalObi,legs="Mallquis Trews +2",feet="Mallquis Clogs +2"})
