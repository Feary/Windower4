...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{"Indi-Precision","Indi-Refresh","Indi-Regen","Indi-STR","Indi-Dex", "Indi-VIT", "Indi-AGI", "Indi-MND", "Indi-CHR"},
        Enhancing = T{"Regen", "Protect", "Regen II", "Protect II", "Stoneskin", "Protect III", "Regen III", "Protect IV"},
        Ninjutsu = T{},
        Singing = T{"Mage's Ballad", "Mage's Ballad II", "Mage's Ballad III", "Victory March", "Advancing March", "Army's Paeon", "Army's Paeon II", "Army's Paeon III", "Army's Paeon IV", "Army's Paeon VI"},
        Blue = T{"Cocoon", "Magic Fruit", "Occultation", "Fantod", "Erratic Flutter", "Battery Charge", "Metallic Body"},
        Summoning = T{"Carbuncle","Fenrir","Leviathan","Ifrit","Titan","Shiva","Garuda","Ramuh","Diabolos","Fire Spirit","Ice Spirit","Air Spirit", "Earth Spirit", "Water Spirit"}},
...
function status_change(new,old)
    ...
    if new=='Idle' then
        if skilluprun then
            send_command('wait 2.0;input /ma "'..gs_skill.skillup_spells[gs_skill.skillup_count]..'" <me>')
        end
