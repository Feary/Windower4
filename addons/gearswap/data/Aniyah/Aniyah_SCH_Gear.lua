...
function init_gear_sets()
    ...
    sets.precast.WS['Myrkr'] = {--ammo="Staunch Tathlum",
		...
		neck="Sanctity Necklace",ear1="Loquacious Earring",ear2="Etiolation Earring",
    ...
    sets.midcast.FastRecast = {main="Earth Staff", sub="Clerisy Strap +1", ammo="Hasty Pinion +1",
		...
		--head="Amalric Coif",
		head="Academic Mortar +1", neck="Voltsurge Torque",ear1="Loquacious Earring",ear2="Etiolation Earring",
		--body="Zendik Robe",
		body="Helios Jacket", hands="Acad. Bracers +1",ring1="Kishar Ring",ring2="Prolix Ring",
		-- Psycloth Lappas
		back=gear.FC_jse_back,waist="Witful Belt",legs="Lengo Pants",feet="Peda. Loafers +1"}
		
    sets.midcast.Cure = {main="Vadose Rod", sub="Sors Shield", ammo="Hasty Pinion +1",
    ...
    sets.midcast.LightDayCure = {main="Vadose Rod", sub="Sors Shield", ammo="Hasty Pinion +1",
		--main="Serenity",sub="Enki Strap", 
		-- head="Vanya Hood", neck="Incanter's Torque"
        head="Gende. Caubeen +1",neck="Colossus's Torque",ear1="Loquacious Earring",ear2="Etiolation Earring",
        body="Heka's Kalasiris",hands=gear_telchine_hands_Cure,ring1="Sirona's Ring",ring2="Lebeche Ring",
    ...
    sets.midcast.Stun = {main="Maxentius", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
        ...
        head="Mallquis Chapeau +2",neck="Voltsurge Torque",ear1="Loquacious Earring", ear2="Etoilation Earring", 
        -- body="Zendik Robe",
		body="Helios Jacket",hands="Acad. Bracers +1",ring1="Kishar Ring",ring2="Prolix Ring",
    ...
    sets.engaged = {main="Maxentius",sub="Genbu's Shield",ammo="Hasty Pinion +1",
		-- ear2="Digni. Earring",
        head="Acad. Mortar. +1",neck="Sanctity Necklace",ear1="Regal Earring",
        body="Acad. Gown +1",hands="Acad. Bracers +1", ring1="Rajas Ring",ring2="Petrov Ring",
		--waist="Flax Sash", feet=gear.chironic_refresh_feet
        back=gear.FC_jse_back, waist="Fucho-no-obi", legs="Acad. Pants +1",feet="Acad. Loafers +1"}
	
	sets.engaged.DW = {main="Maxentius",sub="Genbu's Shield",ammo="Hasty Pinion +1",
		-- ear2="Digni. Earring",
        head="Acad. Mortar. +1",neck="Sanctity Necklace",ear1="Regal Earring",
        body="Acad. Gown +1",hands="Acad. Bracers +1", ring1="Rajas Ring",ring2="Petrov Ring",
		--waist="Flax Sash", feet=gear.chironic_refresh_feet
	...
	sets.engaged.PDT = {main="Maxentius", sub="Genbu's Shield", -- ammo="Staunch Tathlum",
		-- ear2="Digni. Earring",
		head="Acad. Mortar. +1",neck="Sanctity Necklace",ear1="Regal Earring",
        body="Acad. Gown +1",hands="Acad. Bracers +1", ring1="Defending Ring", ring2="Vocane Ring",
        back=gear.FC_jse_back, waist="Fucho-no-obi", legs="Acad. Pants +1",feet="Acad. Loafers +1"}
