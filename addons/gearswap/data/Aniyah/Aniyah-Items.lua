...
sets.Capacity = {back={name="Mecisto. Mantle", augments={'Cap. Point+45%','HP+28','"Mag.Atk.Bns."+3','DEF+10',}}}
...
----gear.grioavolr_macc_staff = 	{name="Grioavolr",augments={'"Fast Cast"+7','MP+20','Mag. Acc.+17','"Mag.Atk.Bns."+10','Magic Damage +5',}}
----gear.grioavolr_refresh_staff = 	{"Grioavolr"}
gear.grioavolr_fc_staff = {name="Grioavolr", augments={'"Mag.Atk.Bns."+16','Weapon skill damage +4%','"Fast Cast"+2','Magic Damage +2',}}
...
gear.merlinic_refresh_hands = {name="Merlinic Dastanas",  augments={'Pet: "Regen"+2','Attack+9','"Refresh"+1',}}
gear.merlinic_magpact_hands = {name="Merlinic Dastanas",  augments={'Pet: Mag. Acc.+13 Pet: "Mag.Atk.Bns."+13','Blood Pact Dmg.+8','Pet: DEX+9','Pet: Mag. Acc.+4','Pet: "Mag.Atk.Bns."+15',}}
gear.merlinic_maccpact_hands = {name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+24 Pet: "Mag.Atk.Bns."+24','Blood Pact Dmg.+7','Pet: INT+1','Pet: Mag. Acc.+10',}}
gear.merlinic_physpact_hands = {name="Merlinic Dastanas", augments={'Pet: Attack+25 Pet: Rng.Atk.+25','Blood Pact Dmg.+8','Pet: Mag. Acc.+13','Pet: "Mag.Atk.Bns."+10',}}
gear.merlinic_accpact_hands = {name="Merlinic Dastanas",  augments={'Pet: Attack+25 Pet: Rng.Atk.+25','Blood Pact Dmg.+8','Pet: Mag. Acc.+13','Pet: "Mag.Atk.Bns."+10',}}
