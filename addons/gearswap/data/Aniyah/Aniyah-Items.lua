...
----gear_grioavolr_macc_staff = 	{name="Grioavolr",augments={'"Fast Cast"+7','MP+20','Mag. Acc.+17','"Mag.Atk.Bns."+10','Magic Damage +5',}}
----gear_grioavolr_refresh_staff = 	{"Grioavolr"}
gear_grioavolr_fc_staff = {name="Grioavolr", augments={'"Mag.Atk.Bns."+16','Weapon skill damage +4%','"Fast Cast"+2','Magic Damage +2',}}
