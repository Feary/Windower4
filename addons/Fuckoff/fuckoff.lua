...
local blackListedUsers = T{'Koohoo','Kooboo','TotallyABotThree','Fudu','Blackjacky','Wowee','Fudoii','Shmilydoittt','Fudoa','Dhozs'} -- Want to block all messages from X user then added there name(s) here.
...
local blackListedWords = T{string.char(0x81,0x99),string.char(0x81,0x9A),'1%-99','Job Point.*2100','Job Point.*500','JP.*2100','JP.*500','Capacity Point.*2100','Capacity Point.*500','CP.*2100','CP.*500','500p/4m','500p/5m','500p/3m','500/4m','500/5m','500/3m','4m/500p','1-50 1m','gilshop','fast delivery!','*99/1*','master*/*m','gil delivery','localgamers.shop','Fast Cast*buy*','Masterlvl*buy','0-20'} -- First two are '☆' and '★' symbols.
